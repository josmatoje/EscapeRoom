...
public class Mensajes {
    ...
    public void Sala(int sala, boolean salaVisitada[], boolean objetosObtenidos[]){
        ...
        switch(sala){ //Se mostrará siempre, una breve descripcion de la sala para no perderse
            ...
            case 2: 
                ...
                System.out.print(" Inspeccionas la cantina y ves una silla de madera en la que se solían sentar los jefes a almorzar, ");

                if(objetosObtenidos[6])
                    System.out.print("restos de comida de algún soldado que estaría comiendo durante el ataque");


                if(objetosObtenidos[7])
                    System.out.print("y algo parecido a las instrucciones de la nave en una mesa");
